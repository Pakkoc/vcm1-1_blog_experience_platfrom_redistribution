...
1. /docs/{requirement,persona,techstack,structure,prd,userflow,database,common-modules}.md, /docs/external/\*.md 문서를 읽고 프로젝트의 상태를 구체적으로 파악한다.
...
- /prompts/05_plan-form.md 형식을 참고하세요.
