### 만들 것
- 광고주와 인플루언서를 연결하는 체험단 매칭 플랫폼
    - 광고주 : 제품 및 서비스를 홍보하기 위해 체험단을 등록과 관리
    - 인플루언서 :  다양한 체험단에 지원하고 활동 결과를 확인

### 개발 목적
광고주에게는 효율적인 체험단 운영 도구를, 인플루언서에게는 간편한 참여 및 관리 경험을 제공하기 위함.
...
1. 홈 (Home)
   ...
   - Hero 섹션 (플랫폼 소개, CTA 버튼, 이미지)
   - 모집 중인 체험단 리스트 (카드 형태, 기본 정렬: 최신순)
   - 플랫폼 특징 소개 (빠른 매칭, 검증된 파트너, 효과적인 홍보)
   - 이용 방법 안내 (광고주/인플루언서 가이드)
   - CTA 섹션 (회원가입 유도)
